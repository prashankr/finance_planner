...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    label: "Budgets",
    shortLabel: "BG",
    description: "Keep category limits visible before overspending starts.",
    accent: "#89c2ff",
  ...
  },
  {
    ...
    label: "Net Worth",
    shortLabel: "NW",
    description: "Watch assets and debt move together in one snapshot.",
    accent: "#d5b2ff",
  ...
  },
  {
    ...
    label: "Settings",
    shortLabel: "ST",
    description: "Tune currency, guardrails, and account defaults.",
    accent: "#8fe3e0",
